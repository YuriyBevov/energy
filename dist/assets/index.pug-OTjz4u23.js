...
document.querySelector(".top-menu-closer");
...
var Tween = /* @__PURE__ */ function(_Animation2) {
  ...
  _proto3.render = function render3(totalTime, suppressEvents, force) {
    ...
    if (!dur) {
      ...
      timeline2 && timeline2.render(totalTime < 0 ? totalTime : !time && isYoyo ? -1e-8 : timeline2._dur * timeline2._ease(time / this._dur), suppressEvents, force) || this._startAt && (this._zTime = totalTime);
...
class MaskedDynamic extends Masked {
  ...
  set state(state) {
    ...
    if (compiledMasks) this.compiledMasks.forEach((m2, mi) => m2.state = compiledMasks[mi]);
